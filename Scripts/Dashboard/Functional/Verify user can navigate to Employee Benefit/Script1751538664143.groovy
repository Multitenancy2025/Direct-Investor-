...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Investor Summary Dashboard/span_Employee Benefit'), 0)
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_My Employee Benefit/button_Current Holdings'))
