...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_My Instructions/button_Unit Trust'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_My Instructions/span_Catalyst Unit Trust InvestmentsCAT00403'))
